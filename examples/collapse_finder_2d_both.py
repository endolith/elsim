"""Find and render one election showing IRV/Baldwin Condorcet contrast."""
...
def find_both_election(n_voters, n_cands, max_trials, disp=1.0):
    """Sample one election satisfying both verified method criteria."""
...
if __name__ == '__main__':
    ...
    if result is None:
        raise RuntimeError(
            'No election found where IRV eliminates the Condorcet winner '
            'center-outward and Baldwin elects it.'
        )
