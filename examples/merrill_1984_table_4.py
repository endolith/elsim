...
Results with 5_000_000 elections:

|    |   Plurality |   Runoff |   Hare |   Borda |   Coombs |   Black |
|:---|-----------:|---------:|-------:|--------:|---------:|--------:|
| .2 |        91.1 |     92.1 |   92.8 |    93.8 |     95.0 |    98.7 |
| .5 |        84.7 |     84.9 |   84.0 |    90.1 |     91.1 |    97.8 |
|1.0 |        72.9 |     73.1 |   70.8 |    83.3 |     83.7 |    95.6 |
|2.0 |        57.9 |     58.1 |   54.6 |    73.3 |     73.5 |    91.6 |
|5.0 |        39.1 |     39.1 |   36.9 |    58.7 |     58.8 |    83.2 |
...
plt.title('Social Utility Efficiency Under Spatial-Model Assumptions')

table = []

# Calculate Social Utility Efficiency from summed utilities
x_uw, y_uw = zip(*sorted(utility_sums['SU max'].items()))
for method in ('Plurality', 'Runoff', 'Hare', 'Borda', 'Coombs', 'Black'):
    x, y = zip(*sorted(utility_sums[method].items()))
    SUE = (np.array(y) / n_elections) / (np.array(y_uw) / n_elections)
